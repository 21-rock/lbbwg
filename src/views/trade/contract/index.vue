...
import { ExchangePanel, EntrustTable } from './components'
import { Divider } from 'ant-design-vue'
import { usePrice } from '../spot/hooks/usePrice'

import { CurrencyPrice } from '@/model/tradeModel'

const currency = ref('BTC/USDT')
...
<template>
  <div class="px-2 bg-black spot-container">
    ...
    <section class="bg-[#161616] text-white" style="grid-area: view">
      <!-- <TradingViewWidget /> -->
      <Kline :currency="currency" :tickerData="tickerData" />
    </section>
